...
| Quality gate | Green - **2 915 tests + 5 strict xfail**, `ruff` + `mypy --strict` over 159 files + **12** `lint-imports` contracts clean. The 5 xfails pin the four NFR5 walls of OD-11: making the claim true turns the suite red |
