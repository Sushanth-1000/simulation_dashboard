...
| Quality gate | Green - **2 908 tests + 5 strict xfail**, `ruff` + `mypy --strict` over 158 files + **12** `lint-imports` contracts clean. The 5 xfails pin the four NFR5 walls of OD-11: making the claim true turns the suite red |
...
| Open defects | **14 in the register - 8 closed, 1 partly closed, 5 open** - every one self-found, none by the test suite. See [`docs/CREDIBILITY_MATRIX.md`](docs/CREDIBILITY_MATRIX.md) |
