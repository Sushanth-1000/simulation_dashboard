...
| Quality gate | Green - **2 924 tests + 5 strict xfail**, `ruff` + `mypy --strict` over 160 files + **12** `lint-imports` contracts clean. The 5 xfails pin the four NFR5 walls of OD-11: making the claim true turns the suite red |
...
| Open defects | **16 in the register - 9 closed, 1 partly closed, 6 open** - every one self-found, none by the test suite. See [`docs/CREDIBILITY_MATRIX.md`](docs/CREDIBILITY_MATRIX.md) |
