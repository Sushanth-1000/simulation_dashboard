...
| Open defects | **21 in the register - 14 closed, 1 reclassified, 2 partly closed, 4 open** - every one self-found, none by the test suite. See [`docs/CREDIBILITY_MATRIX.md`](docs/CREDIBILITY_MATRIX.md) |
