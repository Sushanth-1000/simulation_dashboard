...
| Open defects | **18 in the register - 11 closed, 2 partly closed, 5 open** - every one self-found, none by the test suite. See [`docs/CREDIBILITY_MATRIX.md`](docs/CREDIBILITY_MATRIX.md) |
