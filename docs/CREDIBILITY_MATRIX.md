...
**Five of the original six are closed as of 10 August 2026**, and the register now holds **thirteen rows** — seven closed, one partly closed, five open — each fixed *and re-measured* as
