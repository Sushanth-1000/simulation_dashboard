...
**Five of the original six are closed as of 10 August 2026**, and the register now holds **twenty-one rows** — fifteen closed, one reclassified, two partly closed, three open — each fixed *and re-measured* as
