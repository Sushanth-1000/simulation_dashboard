...
| A-7 | Test suite and coverage | **[M-code]** | **2,920** tests + 5 strict xfail against a 95% gate — E-1 | **Correctness.** See D-0 — a fail-safe that did not fail safe survived all of this for the project's whole life |
