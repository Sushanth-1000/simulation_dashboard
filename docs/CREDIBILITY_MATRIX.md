...
| A-6 | Full static typing | **[M-code]** | `mypy --strict` clean over **158** source files — E-1 | Runtime correctness |
| A-7 | Test suite and coverage | **[M-code]** | **2,908** tests + 5 strict xfail against a 95% gate — E-1 | **Correctness.** See D-0 — a fail-safe that did not fail safe survived all of this for the project's whole life |
...
**Five of the original six are closed as of 10 August 2026**, and the register now holds **fourteen rows** — eight closed, one partly closed, five open — each fixed *and re-measured* as
