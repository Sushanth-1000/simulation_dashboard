...
**Five of the original six are closed as of 10 August 2026**, and the register now holds **twenty-one rows** — fourteen closed, one reclassified, two partly closed, four open — each fixed *and re-measured* as
